...
import com.xtk.anal.mapper.auto.SysNoticeMapper;
import com.xtk.anal.mapper.auto.SysNoticeUserMapper;
import com.xtk.anal.model.auto.SysNotice;
import com.xtk.anal.model.auto.SysNoticeExample;
import com.xtk.anal.model.auto.SysNoticeUser;
import com.xtk.anal.model.auto.SysNoticeUserExample;
import com.xtk.anal.model.auto.SysNoticeUserExample.Criteria;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.xtk.anal.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
